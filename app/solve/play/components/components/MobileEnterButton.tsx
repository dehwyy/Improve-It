...
const MobileEnterButton = () => {
  ...
  return (
    <StyledWrapper
      className="mt-1 col-span-3 text-rose-500 shadow-rose-500/100 shadow-md border-current sm:p-2 transition-all duration-300 bg-gradient-to-tr from-transparent via-transparent active:to-rose-500 to-rose-800"

        ...
        <nav
          ...
          <div className="p-[1rem] pb-0 z-50 ">
            <MenuIcon
              ...
              fontSize="large"
              className={`transition-all text-[3rem] ${!isExpanded && 'bg-[#333333]'} rounded mr-1`}
            />
          </div>
          <Slide in={isExpanded} direction="left" unmountOnExit mountOnEnter>
            <div className="bg-gradient-to-r from-violet-500 to-violet-700 fixed bottom-0 top-0 pt-20 z-40 pr-1">

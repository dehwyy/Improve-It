...
const SettingItem: React.FC<IPropsUI> = ({ mode, customClasses, isActive, onClick }) => {
  return (
    <div
      ...
      }  select-none cursor-pointer flex items-center underline-offset-4 decoration-2 justify-center flex-1 rounded-lg p-4 transition-all bg-[#333333] shadow-lg border-2 border-current hover:border-current`}>
